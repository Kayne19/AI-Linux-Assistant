...
class Project(Base):
    ...
    memory_candidates = relationship(
        "ProjectMemoryCandidate", cascade="all, delete-orphan"
    )
...
class ChatSession(Base):
    ...
    chat_runs = relationship(
        "ChatRun", back_populates="chat_session", cascade="all, delete-orphan"
    )
...
class ChatRun(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "chat_session_id",
            "client_request_id",
            name="uq_chat_runs_chat_client_request",
        ),
    )
    ...
    run_kind: Mapped[str] = mapped_column(
        String(32), default="message", nullable=False, index=True
    )
    ...
    final_user_message_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("chat_messages.id", ondelete="SET NULL")
    )
    final_assistant_message_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("chat_messages.id", ondelete="SET NULL")
    )
    created_at: Mapped[datetime] = mapped_column(
        DateTime(timezone=True), default=_utc_now, nullable=False
    ...
    events = relationship(
        "ChatRunEvent", back_populates="run", cascade="all, delete-orphan"
    )
...
class ChatRunEvent(Base):
    ...
    run_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("chat_runs.id"), nullable=False, index=True
    )
...
class ProjectFact(Base):
    ...
    __table_args__ = (
        UniqueConstraint("project_id", "fact_key", name="uq_project_fact_key"),
    )
...
class ProjectIssue(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "project_id", "normalized_title", name="uq_project_issue_title"
        ),
    )
...
class ProjectAttempt(Base):
    ...
    issue_id: Mapped[int | None] = mapped_column(
        Integer, ForeignKey("project_issues.id")
    )
...
class ProjectMemoryCandidate(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_project_memory_candidates_chat_active", "chat_session_id", "status"),
    )
...
class ProjectState(Base):
    ...
    __table_args__ = (
        UniqueConstraint("project_id", "state_key", name="uq_project_state_key"),
    )
...
class AppSettingsModel(Base):
    ...
    contextualizer_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_skeptic_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_historian_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_arbiter_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_lite_eager_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_lite_skeptic_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    magi_lite_historian_provider: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    magi_lite_historian_model: Mapped[str | None] = mapped_column(Text, nullable=True)
    magi_lite_historian_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    magi_lite_arbiter_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    history_summarizer_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    context_summarizer_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    memory_extractor_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    registry_updater_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    ingest_enricher_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ingest_identity_normalizer_provider: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ingest_identity_normalizer_model: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ingest_identity_normalizer_reasoning_effort: Mapped[str | None] = mapped_column(
        Text, nullable=True
    )
    ...
    retrieval_source_profile_sample: Mapped[int | None] = mapped_column(
        Integer, nullable=True
    )
    history_max_recent_turns: Mapped[int | None] = mapped_column(Integer, nullable=True)
    history_summarize_turn_threshold: Mapped[int | None] = mapped_column(
        Integer, nullable=True
    )
    history_summarize_char_threshold: Mapped[int | None] = mapped_column(
        Integer, nullable=True
    )
