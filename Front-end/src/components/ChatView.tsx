			...
			<div ref={messagesContainerRef} className="messages" onScroll={onScroll}>
				{!selectedProject ? (
					<div className="empty-state">
						...
						<p>
							Projects are the container. Each project keeps its own set of
							chats and context.
						</p>
						<button
							type="button"
					...
					<div className="empty-state">
						...
						<p>
							This project is active, but you still need a chat thread before
					...
					<div className="empty-state">
						...
						<h3>
							{selectedChat?.title ||
								"Start a conversation tied to this project."}
						</h3>
						<p>
							The assistant keeps troubleshooting context scoped to{" "}
							{selectedProject.name}, so this thread can build on prior work.
						</p>
					</div>
				) : (
					<>
							...
							>
								...
								{message.id === streamingAssistantId && selectedChatBusy ? (
									<>
										...
										<div
											className={`message-status-subtext ${message.content.trim() ? "inline" : ""}`}
										>
									...
									<>
										...
										<div className="message-actions">
											{message.role !== "user" &&
											message.council_entries?.length ? (
												<button
													type="button"
