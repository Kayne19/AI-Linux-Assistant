...
const STREAM_STATUS_TEXT: Record<string, StatusEntry> = {
	START: {
		label: "Thinking",
		aliases: ["Thinking", "Getting started"],
	},
	LOAD_MEMORY: {
		label: "Recalling context",
		aliases: ["Trying to recall", "Checking memory"],
	},
	SUMMARIZE_CONVERSATION_HISTORY: {
		label: "Reviewing recent conversation",
		aliases: ["Reviewing the chat", "Looking back"],
	},
	CLASSIFY: {
		label: "Thinking",
		aliases: ["Thinking", "Sorting it out"],
	},
	REWRITE_QUERY: {
		label: "Refining the question",
		aliases: ["Rephrasing the question", "Tightening the search"],
	},
	RETRIEVE_CONTEXT: {
	...
	GENERATE_RESPONSE: {
		...
		aliases: ["Formatting ideas", "Putting it together"],
	},
	SUMMARIZE_RETRIEVED_DOCS: {
		label: "Condensing the evidence",
		aliases: ["Condensing the evidence", "Remembering the important parts"],
	},
	EXTRACT_MEMORY: {
		label: "Saving memory",
		aliases: ["Keeping the useful bits"],
	},
	RESOLVE_MEMORY: {
		label: "Reconciling memory",
		aliases: ["Making sure I head that right", "Checking for conflicts"],
	},
	COMMIT_MEMORY: {
		label: "Committing memory",
		aliases: ["Committing memory", "Saving it for later"],
	},
	retrieval_search_started: {
		label: "Searching documentation",
		aliases: ["Searching docs", "Starting the search"],
	},
	retrieval_candidates_found: {
		label: "Searching documentation",
		aliases: ["Searching docs", "Checking matches"],
	},
	retrieval_sources_filtered: {
		label: "Narrowing to relevant manuals",
		aliases: ["Filtering sources", "Narrowing it down"],
	},
	retrieval_reranking: {
		label: "Comparing relevant sources",
		aliases: ["Comparing sources", "Choosing the best answers"],
	},
	retrieval_source_boosting: {
		label: "Weighing the evidence",
		aliases: ["Weighting the evidence", "Boosting strong sources"],
	},
	retrieval_expanding: {
		label: "Expanding search",
		aliases: ["Expanding search", "Looking wider", "Consulting more sources"],
	},
	retrieval_complete: {
		label: "Reading manuals",
		aliases: ["Reading manuals", "Using the docs"],
	},
	web_search_used: {
	...
	"tool:search_rag_database": {
		label: "Reading manuals",
		aliases: ["Reading manuals", "Searching project docs"],
	},
	"tool:search_RAG_database": {
		label: "Reading manuals",
		aliases: ["Reading manuals", "Searching project docs"],
	...
	"tool:search_attempt_log": {
		label: "Recalling context",
		aliases: ["Trying to recall", "Checking past attempts"],
	},
	"tool:default": {
		label: "Using tools",
		aliases: ["Using tools", "Working in the background"],
	},
	"responder:WEB_SEARCH": {
		label: "Consulting the marketplace of ideas",
		aliases: ["Consulting the internet", "Checking the web"],
	},
	"responder:PROCESS_TOOL_CALLS": {
		label: "Using tools",
		aliases: ["Using tools", "Running tool calls"],
	},
	"responder:SUBMIT_TOOL_RESULTS": {
		label: "Reviewing tool results",
		aliases: ["Reviewing tool results", "Checking tool output"],
	},
	"responder:REQUEST_MODEL": {
		label: "Thinking",
		aliases: ["Thinking", "Taking another pass"],
	},
	"responder:default": {
		label: "Writing response",
		aliases: ["Writing response", "Still writing"],
	},
	"magi:OPENING_ARGUMENTS": {
		label: "Deliberating",
		aliases: ["Starting deliberation", "Gathering perspectives"],
	},
	"magi:ROLE_EAGER": {
		label: "Eager is proposing",
		aliases: ["Generating hypothesis", "Taking a first pass"],
	},
	"magi:ROLE_SKEPTIC": {
		label: "Skeptic is challenging",
		aliases: ["Playing devil's advocate", "Looking for holes"],
	},
	"magi:ROLE_HISTORIAN": {
		label: "Historian is verifying",
		aliases: ["Checking project history", "Consulting past experience"],
	},
	...
	"magi:DISCUSSION": {
		...
		aliases: ["Refining the diagnosis", "Comparing perspectives"],
	},
	"magi:DISCUSSION_EAGER": {
		label: "Eager is responding",
		aliases: ["Eager has more to say"],
	},
	"magi:DISCUSSION_SKEPTIC": {
		label: "Skeptic is responding",
		aliases: ["Skeptic has more to say"],
	},
	"magi:DISCUSSION_HISTORIAN": {
		label: "Historian is responding",
		aliases: ["Historian has more to say"],
	},
	"magi:CLOSING_ARGUMENTS": {
		label: "Closing arguments",
		aliases: ["Committing to conclusions", "Final positions forming"],
	},
	"magi:CLOSING_EAGER": {
		label: "Eager is closing",
		aliases: ["Eager commits", "Eager's final take"],
	},
	"magi:CLOSING_SKEPTIC": {
		label: "Skeptic is closing",
		aliases: ["Skeptic commits", "Skeptic's final take"],
	},
	"magi:CLOSING_HISTORIAN": {
		label: "Historian is closing",
		aliases: ["Historian commits", "Historian's final take"],
	},
	"magi:ARBITER": {
		label: "Arbiter is synthesizing",
		aliases: ["Reaching a verdict", "Writing final answer"],
	},
	paused: {
		label: "Paused",
		aliases: ["Waiting for your input", "Holding for intervention"],
	},
	pause_requested: {
		label: "Pausing",
		aliases: ["Stopping at a safe point", "Finishing the current checkpoint"],
	},
	magi_intervention_added: {
		label: "User input added",
		aliases: ["Incorporating your input", "Updating the discussion"],
	},
	"magi:default": {
		label: "Deliberating",
		aliases: ["Deliberating", "Magi system active"],
	},
};
